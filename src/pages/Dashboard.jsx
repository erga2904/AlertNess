...
import { EarlyWarningPanel, FamilyTracker, QuickActions, LiveFeed } from '../components/DashboardPanels';
import { RealTimeIntensityGauge } from '../components/CustomCharts';
    ...
    return (
        <div className="dashboard-grid">
            <div className="dashboard-main">
                {/* Hero Card */}
                <div className="dash-hero dash-item">
            ...
            <div className="dash-dirasakan dash-item">
            {/* Dirasakan */}
            ...
            <RealTimeIntensityGauge latest={latest} />
            </div>

            {/* Recent Quakes List */}
            <div className="dash-recent dash-item mt-lg">
                ...
                <div className="quake-list">
                    {(showAllRecent ? recent : recent.slice(0, 3)).map((q, i) => {
                    ...
                    <div style={{ marginTop: '16px', textAlign: 'center' }}>
                        <button 
                            ...
                            onMouseOver={(e) => { e.currentTarget.style.color = '#fff'; e.currentTarget.style.borderColor = '#60a5fa'; e.currentTarget.style.background = 'rgba(96, 165, 250, 0.1)'; }}
                            onMouseOut={(e) => { e.currentTarget.style.color = '#94a3b8'; e.currentTarget.style.borderColor = 'rgba(148, 163, 184, 0.4)'; e.currentTarget.style.background = 'transparent'; }}
                        >
                            {showAllRecent ? 'Sembunyikan Riwayat' : 'Lihat Selengkapnya (Riwayat Gempa)'}
                        </button>
                    </div>
                </div>
            </div>
            ...
            {/* Right Sidebar for Panels (Section 3, 4, 5, 6) */}
            <div className="dashboard-sidebar">
                <div className="dash-warning dash-item"><EarlyWarningPanel latest={latest} /></div>
                <div className="dash-tracker dash-item"><FamilyTracker /></div>
                <div className="dash-actions dash-item"><QuickActions /></div>
                <div className="dash-live dash-item"><LiveFeed quakes={recent} /></div>
            </div>
        </div>
    );
}
